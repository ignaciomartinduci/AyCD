% Flags de ejecución
escenario = 2; % 0: espera- 1: ciclo simple carga - 2: ciclo simple descarga - 3: ciclo doble (carga + descarga)
...
container_pillars = [8, 10, 11, 11, 12, 12, 16, 16, 14, 8, 7, 7, 6, 6, 6, 8, 10, 9, 9];
trucks0 = [0, 0, 0, 0, 0];
H_truck = 1;
