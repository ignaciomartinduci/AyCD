...
J_tEq = J_tm_tb+(J_td/i_t^2)+((M_t)*r_td^2/i_t^2)+m_l*r_td^2/i_t^2; % Considera motor + tambor + carro
b_tEq = b_tm+(b_td/i_t^2)+(b_t*r_td^2/i_t^2); % Considera motor + tambor + carro
